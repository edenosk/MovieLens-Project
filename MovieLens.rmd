...
title: "PH125.9x - capstone: covieLens croject"
...
 
In this project, we will be working with the [MovieLens 10M]
 
...
# Conclusion
 
Throughout this project, we explored the MovieLens 10M dataset, focusing on four variables—two existing and two calculated. We conducted exploratory data analysis to derive insights for model development. The recommendation system incorporated effects for movies, users, release years, and rate timestamps, regularized with a tuning parameter of 0.5. This approach achieved an RMSE of r rmse_model_final on the Validation Set.
 
Despite meeting the RMSE goal, future improvements include:
 
1. Addressing under-ranked movies with fewer ratings.
 
2. Integrating the "genres" variable for richer predictions.
 
3. Enriching data with APIs for additional movie attributes.
 
4. Utilizing larger, more recent datasets.
 
5. Exploring advanced ML techniques for enhanced precision.
 
 
 
# References
